...
def solve(algorithm_name):
    ...
    if solution:
        ...
        if running:
            steps_count.config(text=f"Bước: {len(solution)}")
...
steps_count = tk.Label(info_frame, text="Bước: 0", font=("Arial", 10),
                       fg="#000000", bg="#FFFFFF")
...
# Thêm các nút radio cho thuật toán với cỡ chữ lớn hơn
algorithms = ["bfs", "dfs", "ucs", "ids", "greedy", "a_star", "ida_star", "simple_hill_climbing", "steepest_ascent_hill_climbing"]
